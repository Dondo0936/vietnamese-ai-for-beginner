  ...
  return (
    <>
      ...
      <LessonSection step={3} totalSteps={TOTAL_STEPS} label={LESSON_LABELS[2]}>
        <p className="mb-4 text-sm text-muted leading-relaxed">
          Bật từng kỹ thuật để xem <strong className="text-foreground">cumulative speedup</strong>. hiệu ứng nhân lên khi kết hợp. Không tối ưu nào là miễn phí: mỗi kỹ thuật
