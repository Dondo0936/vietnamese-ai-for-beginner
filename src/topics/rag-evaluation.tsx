        ...
        <g transform="translate(30, 10)">
          ...
          {[
            ...
            <g key={l.name}>
              ...
              <text x={l.pos.x} y={l.pos.y + 12} textAnchor={l.anchor} fontSize={11} fill="var(--text-primary)">
                {l.score}
              </text>
            </g>
          ))}
          {/* Composite ở giữa */}
          <text x={cx} y={cy - 2} textAnchor="middle" fontSize={11} fill="var(--text-secondary)">composite</text>
