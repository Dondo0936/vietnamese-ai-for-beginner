  ...
  reporting:
    ...
    on_regression: slack://#ai-quality`}
          ...
          >
            <AhaMoment>
              <p>
                Đánh giá Agent không phải chỉ &quot;đúng hay sai&quot;. Đó là <strong>đánh giá cả hành trình</strong>. Hai Agent
        ...
        with:
          ...
          path: reports/eval_*.json`}
              ...
              <p className="text-sm mt-4">
                ...
                <TopicLink slug="guardrails">Guardrails</TopicLink>. chúng là &quot;immune system&quot; của agent production,
