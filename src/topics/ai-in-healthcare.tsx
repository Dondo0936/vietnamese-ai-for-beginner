...
export default function AIInHealthcareTopic() {
  const quizQuestions: QuizQuestion[] = useMemo(() => [
    ...
    {
      type: "fill-blank",
      question: "Hai ứng dụng nổi bật nhất của AI y tế là hỗ trợ {blank} bệnh qua phân tích triệu chứng và phân tích hình ảnh từ {blank} y khoa (X-quang, CT, MRI).",
      blanks: [
        { answer: "chẩn đoán", accept: ["diagnosis", "chẩn đoán bệnh", "chan doan"] },
        { answer: "hình ảnh", accept: ["imaging", "hinh anh", "ảnh y khoa", "medical imaging"] },
      ],
      explanation: "Medical imaging AI (CheXNet, VinDr-CXR) dùng CNN phân tích X-quang/CT/MRI phát hiện bệnh. Kết hợp với LLM để tóm tắt bệnh án và hỗ trợ chẩn đoán. Luôn có bác sĩ review quyết định cuối cùng.",
    },
  ], []);
  ...
  return (
    <><LessonSection step={1} totalSteps={TOTAL_STEPS} label="Dự đoán">
      ...
      <LessonSection step={5} totalSteps={TOTAL_STEPS} label="Lý thuyết"><ExplanationSection>
        <p><strong>AI in Healthcare</strong>{" "}ứng dụng AI hỗ trợ <TopicLink slug="image-classification">chẩn đoán hình ảnh</TopicLink>, phát triển thuốc, và dự đoán bệnh — luôn dùng cạnh bác sĩ, không thay thế. Do quyết định ảnh hưởng tính mạng, AI y tế bắt buộc phải có <TopicLink slug="explainability">explainability</TopicLink>{" "}(ví dụ Grad-CAM để chỉ ra vùng lá phổi bất thường).</p>
