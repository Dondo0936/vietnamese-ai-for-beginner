...
export const metadata: TopicMeta = {
  ...
  description:
    "Ba người bạn cùng khen một quán phở. Bạn tin hơn hẳn một người khen. Naive Bayes biến trực giác cộng dồn bằng chứng đó thành phép nhân xác suất gọn gàng.",
  category: "classic-ml",
...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      "Vì giả định các từ độc lập nhau. Thực tế hiếm khi đúng, nhưng kết quả vẫn rất khá",
      "Vì chỉ dùng được cho dữ liệu nhỏ",
      "Vì không cần huấn luyện",
    ],
    correct: 1,
    explanation:
      "Trong thực tế, 'khuyến mãi' và 'miễn phí' rõ ràng không độc lập. Email spam thường có cả hai. Nhưng Naive Bayes vẫn giả định chúng độc lập để giữ phép nhân gọn. Cái 'ngây thơ' đó vẫn cho ra bộ lọc spam chạy tốt.",
  },
  {
    question:
      "Email chứa đúng một từ là 'blockchain'. Tập huấn luyện chưa từng thấy 'blockchain' ở lớp Spam, nên P(blockchain|Spam) = 0. Chuyện gì xảy ra nếu không có kỹ thuật làm mượt?",
    options: [
    ...
    correct: 1,
    explanation:
      "Một số hạng bằng 0 trong phép nhân kéo cả tích về 0 ngay lập tức. Laplace smoothing thêm +1 vào mọi đếm để không có xác suất nào bằng 0. Đó là lý do scikit-learn luôn bật smoothing mặc định.",
  },
  {
    type: "fill-blank",
    question:
  ...
  },
  {
    ...
    options: [
      ...
      "Nhân tất cả xác suất từ với prior rồi so sánh hai phía. Kết quả phụ thuộc độ mạnh của từng bằng chứng",
      "Không thể phân loại",
    ],
    correct: 2,
    explanation:
      "Naive Bayes không để một từ duy nhất quyết định. Nó cộng dồn (qua phép nhân xác suất) mọi bằng chứng, kể cả từ nhẹ. Khi bằng chứng đến từ cả hai phe, phe có xác suất lớn hơn thắng. Đôi khi sát nút, đôi khi áp đảo.",
  },
];
    ...
    <>
      ...
      <LessonSection step={1} totalSteps={8} label="Thử đoán">
        <PredictionGate
          ...
          correct={1}
          explanation="Chính xác. Não bạn tự động cộng dồn bằng chứng độc lập. Mỗi lời khen là một manh mối nhỏ. Ba manh mối cùng chiều khiến bạn tự tin hơn hẳn. Naive Bayes làm đúng việc này, chỉ khác ở chỗ nó nhân các xác suất lại một cách có hệ thống."
        >
          <p className="text-sm text-muted mt-4 leading-relaxed">
            Nếu bạn từng <em>tự động</em> thấy chắc chắn hơn khi có nhiều
            bằng chứng cùng chiều, bạn đã dùng một dạng của Naive Bayes
            trong đầu. Cả bài này biến trực giác đó thành một phép tính
            gọn, đủ để máy chạy trên hàng triệu email mỗi giây.
          </p>
        </PredictionGate>
      </LessonSection>
      ...
      <LessonSection step={2} totalSteps={8} label="Hiểu bằng hình ảnh">
        <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
          ...
          <p className="text-sm text-foreground/85 leading-relaxed">
            ...
            <strong>một lá phiếu</strong>, nhưng không phải ai cũng có sức
            nặng bằng nhau. Từ &ldquo;trúng thưởng&rdquo; cầm tấm thẻ to
            tướng: <em>80% email chứa từ này là spam</em>. Từ
            &ldquo;họp&rdquo; cầm thẻ ngược chiều:{" "}
            <em>58% email chứa từ này là công việc</em>.
          </p>
          <p className="text-sm text-foreground/85 leading-relaxed">
            Naive Bayes <strong>cộng dồn</strong> tất cả lá phiếu, không để
            một lá phiếu lớn quyết định mọi thứ. Nếu email chứa cả
            &ldquo;trúng thưởng&rdquo; lẫn &ldquo;báo cáo&rdquo;, thuật
            toán so sánh hai phe xem bên nào mạnh hơn.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-2">
            ...
            <div className="rounded-xl border border-sky-200 bg-sky-50 dark:bg-sky-900/20 dark:border-sky-800 p-4 space-y-1">
              ...
              <p className="text-xs text-foreground/80 leading-relaxed">
                Nhân xác suất từng từ với prior, so sánh hai phe. Phe lớn
                hơn thắng.
              </p>
            </div>
          </div>
        ...
        <VisualizationSection topicSlug={metadata.slug}>
            ...
            {result.contributions.length > 0 && (
              <div className="rounded-xl border border-border bg-surface/40 p-4">
                ...
                <p className="text-[11px] text-muted mt-3 italic leading-relaxed">
                  Độ đỏ và xanh ở thanh ngang là tỉ lệ P(từ|Spam) so với
                  P(từ|Ham). Đỏ càng dài, từ đó càng là manh mối nghiêng về spam.
                </p>
              </div>
            )}
          </LessonSection>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              ...
              <p className="text-[11px] text-foreground/80">
                1 từ spam cộng 1 từ công việc. Kết quả sát nút.
              </p>
            </button>
          </div>
      ...
      <LessonSection step={4} totalSteps={8} label="Mổ xẻ một lần phân loại">
        ...
        <StepReveal
          labels={[
            ...
            "Bước 4: chuẩn hoá để so sánh hai phe",
          ]}
        >
          {[
            <StepPrior key="s1" />,
      ...
      <LessonSection step={5} totalSteps={8} label="Khoảnh khắc hiểu">
        <AhaMoment>
          ...
          Đó là lý do một thuật toán &ldquo;ngây thơ&rdquo; vẫn làm xương
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="rounded-xl border border-border bg-card p-4 space-y-2">
            ...
            <p className="text-xs text-foreground/85 leading-relaxed">
              &ldquo;trúng thưởng&rdquo; có likelihood ratio 41:1. Một từ
      ...
      {/* BƯỚC 5.5: hai loại lỗi */}
      <LessonSection label="Hai loại lỗi: false positive và false negative">
        <div className="rounded-2xl border border-border bg-card p-5 space-y-4">
          <p className="text-sm text-foreground/85 leading-relaxed">
            Khi bộ lọc sai, có hai kiểu sai khác hẳn nhau về hậu quả.
            Gmail chọn nghiêng về một kiểu. Bạn đoán kiểu nào quan trọng
            hơn?
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="rounded-xl border-2 border-red-300 bg-red-50/60 dark:bg-red-900/20 dark:border-red-700 p-4 space-y-2">
              ...
              <p className="text-xs text-foreground/85 leading-relaxed">
                ...
                quan trọng. Hậu quả: bạn không thấy email từ sếp, khách
                hàng, ngân hàng.
              </p>
            ...
            <div className="rounded-xl border-2 border-amber-300 bg-amber-50/60 dark:bg-amber-900/20 dark:border-amber-700 p-4 space-y-2">
              ...
              <p className="text-xs text-foreground/85 leading-relaxed">
                Bộ lọc nói &ldquo;HAM&rdquo; nhưng thực tế là spam. Hậu
                quả: bạn thấy vài quảng cáo trong hộp thư đến.
              </p>
              <p className="text-xs text-foreground font-semibold">
          ...
          <p className="text-xs text-muted italic leading-relaxed">
            ...
            positive thực tế dưới 0.2%, tức cứ 1.000 email hợp lệ chỉ
            chặn nhầm 2.
          </p>
        </div>
      </LessonSection>
      ...
      <LessonSection step={7} totalSteps={8} label="Giải thích">
        <ExplanationSection>
          ...
          <p className="leading-relaxed">
            ...
            là spam).{" "}
            <strong>P(x|c)</strong> là khả năng, xác suất email có nội dung
            x khi biết nó thuộc lớp c.{" "}
            <strong>P(c|x)</strong> là kết quả bạn cần, xác suất email là
            spam khi đã biết nội dung.
          </p>
          ...
          <div className="rounded-xl border border-border bg-surface/40 p-5 my-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="rounded-lg border border-emerald-300 bg-emerald-50 dark:bg-emerald-900/20 dark:border-emerald-700 p-3">
                ...
                <p className="text-xs text-foreground/85 leading-relaxed">
                  Sau khi xem nội dung: xác suất mới. Bạn đã cập nhật niềm
                  tin.
                </p>
              </div>
            </div>
          ...
          <p className="leading-relaxed">
            ...
            Bayes giả định các từ <strong>độc lập nhau</strong> khi biết
            lớp:
          </p>
          ...
          <Callout variant="warning" title="Laplace smoothing chống xác suất bằng 0">
            ...
            kéo toàn bộ tích về 0. Một từ lạ có thể &ldquo;giết&rdquo; cả
            dự đoán. Giải pháp: thêm +1 vào mọi đếm (đôi khi viết là +α).
            Nhờ vậy không xác suất nào bằng 0 tuyệt đối. Scikit-learn mặc
            định đã bật smoothing.
          </Callout>

          <Callout variant="tip" title="Vì sao Naive Bayes vẫn chạy được trên hàng triệu email">
            Huấn luyện Naive Bayes chỉ là việc <strong>đếm từ</strong>. Độ
            phức tạp tỉ lệ tuyến tính với số email và số từ. Không có ma
            trận đảo, không có gradient descent. Đó là lý do bộ lọc spam
            đầu tiên của Gmail dùng Naive Bayes, và đến nay nhiều hệ thống
            filter vẫn giữ Naive Bayes làm lớp kiểm tra đầu vì cực nhanh.
          </Callout>
          ...
          <p className="text-sm text-muted leading-relaxed mb-3">
            Có hai pha. Huấn luyện chạy một lần, chậm nhưng chỉ đếm từ.
            Suy luận chạy cho mỗi email, cực nhanh. Nhờ vậy Naive Bayes
            theo kịp tốc độ hàng tỷ email mỗi ngày.
          </p>
          ...
          <p className="leading-relaxed mt-4">
            ...
            hoặc SVM, hai mô hình học trực tiếp ranh giới giữa các lớp mà
            không cần giả định độc lập.
          </p>
          ...
          <CollapsibleDetail title="Tại sao 'sai về xác suất' mà 'đúng về phân loại'?">
            <p className="text-sm leading-relaxed">
              ...
              bị <strong>phóng đại</strong>. Nhưng phép phóng đại đó cũng
              xảy ra trong công thức P(Ham|email), dù nhẹ hơn. Khi chia
              hai giá trị để so sánh, sai số bị triệt tiêu một phần. Kết
              quả: xác suất tuyệt đối có thể sai lệch (Naive Bayes nói
              99% spam khi thực tế 85%), nhưng thứ tự &ldquo;spam hay
              ham&rdquo; vẫn thường đúng. Phân loại chỉ cần đúng thứ tự.
            </p>
          </CollapsibleDetail>
          ...
          <CollapsibleDetail title="Liên hệ với các thuật toán khác">
            <p className="text-sm leading-relaxed">
              ...
              <em>discriminative model</em>, học thẳng ranh giới giữa các
              lớp mà không mô hình hoá cách dữ liệu phát sinh. Cả hai đều
              có điểm mạnh riêng. Generative thường cần ít dữ liệu hơn để
              bắt đầu, còn discriminative thường chính xác hơn khi dữ
              liệu đủ lớn.
            </p>
          </CollapsibleDetail>
          ...
          <CollapsibleDetail title="Khi nào Naive Bayes thực sự kém?">
            <div className="space-y-2 text-sm leading-relaxed">
              <p>
                ...
                dự đoán giá nhà dùng diện tích và số phòng ngủ. Hai biến
                này tương quan khoảng 0.85, và Naive Bayes sẽ đếm hiệu ứng
                &ldquo;nhà lớn&rdquo; hai lần.
              </p>
              <p>
                Khi <strong>dữ liệu rất nhiều và đa dạng</strong>:
                logistic regression hoặc neural network có thể mô hình hoá
                phụ thuộc trực tiếp, dẫn đến độ chính xác cao hơn 3 đến 8%.
                Trong bài toán spam filter hiện đại, Naive Bayes chỉ còn
                là một trong nhiều tín hiệu. Gmail kết hợp nó với
                reputation IP, DKIM, cấu trúc header, và cả mô hình học
                sâu.
              </p>
              <p>
                <strong>Mặc dù vậy:</strong> Naive Bayes vẫn là lựa chọn
                đầu tiên khi bạn cần kết quả trong vài giờ, có ít dữ liệu
                (khoảng 200 mẫu mỗi lớp), hoặc cần giải thích được cho
                stakeholder. Mỗi từ có một con số đóng góp rõ ràng.
              </p>
            </div>
          </CollapsibleDetail>
        </ExplanationSection>
  ...
  return (
    <div className="rounded-xl border border-border bg-surface/60 p-5 space-y-4">
      <p className="text-sm text-foreground leading-relaxed">
        ...
        Mỗi từ góp một tỉ số P(từ|Spam) chia cho P(từ|Ham), gọi là{" "}
